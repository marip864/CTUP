...
def calculadora(tupla):
    ...
    transformações_bonitas = [] #Aqui ficam os valores aproximados
...
#Se for um ciclo, calcula o rendimento aproximado.
    if teste[0] == teste[-1]:
        rendimento = W/Qr
        transformações_bonitas.append(round(rendimento, 3))
#Agora transforma os dados na tupla a ser retornada.
    transformações_bonitas = tuple(transformações_bonitas)
    return transformações_bonitas
